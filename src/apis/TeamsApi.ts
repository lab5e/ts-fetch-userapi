...
import {
    ...
    MemberListToJSON,
    MemberOfATeam,
    MemberOfATeamFromJSON,
    MemberOfATeamToJSON,
    RequestInviteDetails,
    RequestInviteDetailsFromJSON,
    RequestInviteDetailsToJSON,
    RpcStatus,
    RpcStatusFromJSON,
    RpcStatusToJSON,
    Team,
...
export class TeamsApi extends runtime.BaseAPI {
    ...
    async generateInviteRaw(requestParameters: GenerateInviteRequest): Promise<runtime.ApiResponse<Invite>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: RequestInviteDetailsToJSON(requestParameters.body),
        });
    ...
    async updateMemberRaw(requestParameters: UpdateMemberRequest): Promise<runtime.ApiResponse<Member>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: MemberOfATeamToJSON(requestParameters.body),
        });
    ...
    async updateTeamRaw(requestParameters: UpdateTeamRequest): Promise<runtime.ApiResponse<Team>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ATeamToJSON(requestParameters.body),
        });
